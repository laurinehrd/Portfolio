...
<header class="header-bg uk-background-fixed uk-light uk-background-cover">
  ...
  <!-- ********************TYPPING EFFECT*********************** -->
      <div class="wrapper">
        ...
        <div id="typping-effect" data-text></div>
        ...
        <ul class="uk-slideshow-items">
            <li class="py-3 px-3">
              <div class="uk-card uk-card-default uk-card-hover uk-card-large uk-card-body">
                ...
                Après avoir travaillé dans la vente, j'ai rejoint cette année la formation Access Code School et je serais bientôt titulaire du titre de Développeuse web et Designer web.<br>
                Je me suis tournée vers ce milieu car j'étais très curieuse de savoir comment créer un site web, de son interface à son fonctionnement.</p>
              </div>
            </li>
            <li class="py-4 px-3">
              <div class="uk-card uk-card-default uk-card-hover uk-card-large uk-card-body">
                <h3 class="uk-card-title">Ma personnalité</h3>
                <p>J'ai trouvé un épanouissement personnel à travers ce métier, car je suis curieuse, j'aime apprendre de nouvelles choses chaque jour, et faire des tâches aussi bien différentes par la variété des langages web, qu'amusante par la variété de projets.</p>
              </div>
            </li>
            <li class="py-4 px-3">
              <div class="uk-card uk-card-default uk-card-hover uk-card-large uk-card-body">
